/datum/foreign_realm/kazengun
	...
	hail_lines = list(
		...
		"I have heard of the fame of Valmorian fishes. Big! Long! Fat, tasty and succulent. Full of umami. We have Lingyuese runic chest to preserve it for the journey home. Now, summon your best fisherman and sell me your best price for a catch of Valmorian cod, salmon, and crabs. I only want the expensive, truly good ones, not the cheap one - these are not worth the space on my ship. Please, do not be like the less Factor who tried to offer me cheap fishes and pass them off. Us Kazengunese know the difference, and I will not be fooled.",
	)
