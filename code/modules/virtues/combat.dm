...
//VALMORIAN: 2026-08-21 - "Trained & Ready" retired in favour of the per-archetype backgrounds it
//overlapped with (Duelist/Executioner/Militia/Brawler cover swords/knives/axes/whips/maces/
//polearms/slings/unarmed; see background.dm). Staves has no background equivalent - minor gap,
//matches ES's own design, which never covered staves either.

//VALMORIAN: bowman + crossbowman retired and merged into background/bowman (Toxophilite), matching
//Emerald Summit PR #240's equipment-choice design.
