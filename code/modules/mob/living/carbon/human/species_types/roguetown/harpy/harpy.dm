...
/datum/species/harpy
	...
	<span style='color: #6a8cb7;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000;'><b>Flight | Innate Singing</b></span> | <span style='color: #cc0f0f;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000;'><b>Can't wear boots</b></span>"
...
/datum/species/harpy/get_skin_list()
	return list(
		...
		"Valmoria" = SKIN_COLOR_SCARLET_REACH,
...
/datum/species/harpy/get_skin_list_tooltip()
	return list(
		...
		"Valmoria <span style='border: 1px solid #161616; background-color: #[SKIN_COLOR_SCARLET_REACH];'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>" = SKIN_COLOR_SCARLET_REACH,
