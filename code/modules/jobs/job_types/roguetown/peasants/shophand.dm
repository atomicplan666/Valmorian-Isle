/datum/job/roguetown/shophand
	...
	tutorial = "You are a shophand, hired by the Valmorian Trading Company to work one of their many storefronts around town. Your duties are simple: keep the shelves stocked, keep the customers happy, and try not to get sacked. It is not glamorous work, but you serve under the Factor of Valmoria - second only to the Grand Factor themselves. Keep your eyes on the ledgers, learn what you can, and one day you may rise to Factor yourself. Then the mammons shall flow - into your pouch."
	...
	virtue_restrictions = list(/datum/virtue/background/blacksmith, /datum/virtue/background/hunter, /datum/virtue/background/physician, /datum/virtue/background/artificer, /datum/virtue/background/forester, /datum/virtue/background/tailor, /datum/virtue/background/enchanter, /datum/virtue/background/mining) //Commerce role, not a craftsman.
