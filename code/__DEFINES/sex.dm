...
#define SEX_SPEED_LUDICROUS 5 //Bed Breaker / Fallen only

#define SEX_SPEEDS list(SEX_SPEED_LOW, SEX_SPEED_MID, SEX_SPEED_HIGH, SEX_SPEED_EXTREME, SEX_SPEED_LUDICROUS)
...
#define SEX_FORCE_LUDICROUS 5 //Bed Breaker / Fallen only

#define SEX_FORCES list(SEX_FORCE_LOW, SEX_FORCE_MID, SEX_FORCE_HIGH, SEX_FORCE_EXTREME, SEX_FORCE_LUDICROUS)
