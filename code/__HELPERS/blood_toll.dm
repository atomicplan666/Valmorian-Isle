...
/proc/blood_toll_score_grade(per_capita)
	...
	if(per_capita < BLOOD_TOLL_THRESHOLD_C)
		return list("grade" = "D", "copy" = "VALMORIA HAS FALLEN", "color" = "#bd1717")
	if(per_capita < BLOOD_TOLL_THRESHOLD_B)
		return list("grade" = "C", "copy" = "VALMORIA STUMBLES", "color" = "#c87a3a")
	if(per_capita < BLOOD_TOLL_THRESHOLD_A)
		return list("grade" = "B", "copy" = "VALMORIA STANDS FAST", "color" = "#c4b454")
	if(per_capita < BLOOD_TOLL_THRESHOLD_S)
		return list("grade" = "A", "copy" = "VALMORIA TRIUMPHS", "color" = "#7ec46a")
	return list("grade" = "S", "copy" = "VALMORIA CAME, SAW AND CONQUERED", "color" = "#e6c060")
